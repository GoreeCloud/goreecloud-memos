...
- lightweight quick-find semantics with case-insensitive content/label matching and normalized exact label filtering; and
- focused unit coverage for identity, capture, editing, lifecycle, pinning, labels, search, and filtering behavior.
