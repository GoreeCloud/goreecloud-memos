...
- Unit tests for memo creation, validation, migration, editing, colors, labels, pin ordering, capture, lifecycle transitions, and permanent-deletion guards.
- Chromium end-to-end tests for draft recovery, persistence across reload, organization-metadata autosave, manual pin ordering, Archive/Trash recovery, permanent deletion, and v1/v2 → v3 IndexedDB migration.
