...
>(({ className, children, side = "right", ...props }, ref) => {
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetClose className="ring-offset-background absolute top-4 right-4 rounded-xs opacity-60 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
