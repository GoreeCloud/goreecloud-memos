...
const getRouteMeta = (pathname: string) => {
  ...
  if (pathname === ROUTES.SETTING)
    return { eyebrow: "Control", title: "Settings", subtitle: "Shape GoreeCloud Memos around the way you capture." };
  ...
  if (pathname === ROUTES.ABOUT)
    return { eyebrow: "GoreeCloud", title: "About Memos", subtitle: "Product, version, and source information." };
  ...
  return { eyebrow: "GoreeCloud Memos", title: "Workspace", subtitle: "Fast, private capture with a focused GoreeCloud experience." };
};

const GoreeCloudMemosHeader = () => {
...
export default GoreeCloudMemosHeader;
