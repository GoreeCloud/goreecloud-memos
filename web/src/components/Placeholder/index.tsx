  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
        className="gc-context-icon flex size-12 items-center justify-center rounded-2xl border border-border/70 text-primary shadow-sm"
      >
        <Icon className={cn("size-5", isLoading && "animate-spin")} strokeWidth={1.7} />
      </div>
