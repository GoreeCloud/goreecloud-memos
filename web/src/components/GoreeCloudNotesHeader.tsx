...
const getRouteMeta = (pathname: string) => {
  ...
  if (pathname === ROUTES.SETTING) return { eyebrow: "Control", title: "Settings", subtitle: "Shape GoreeCloud Memos around the way you capture." };
  if (pathname === ROUTES.VIEWS) return { eyebrow: "Organization", title: "Views", subtitle: "Saved ways to return to the notes that matter." };
  if (pathname === ROUTES.ABOUT) return { eyebrow: "GoreeCloud", title: "About Memos", subtitle: "Product, version, and source information." };
