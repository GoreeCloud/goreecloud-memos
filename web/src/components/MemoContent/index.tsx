  ...
  return (
    <div className={`w-full flex flex-col justify-start items-start text-foreground ${className || ""}`}>
      <div
        ...
        className={cn(
          "relative w-full max-w-full wrap-break-word text-base leading-6 max-[599px]:text-[0.98rem] max-[599px]:leading-[1.55]",
          "[&>*:last-child]:mb-0",
          // GoreeCloud Memos treats a leading Markdown H1 as the memo title. Keep
          // ordinary H1s elsewhere in the document on the upstream heading scale.
          "[&>h1:first-child]:mt-0 [&>h1:first-child]:mb-2 [&>h1:first-child]:border-0 [&>h1:first-child]:pb-0 [&>h1:first-child]:text-lg [&>h1:first-child]:font-medium [&>h1:first-child]:leading-6 max-[599px]:[&>h1:first-child]:text-[1.14rem] max-[599px]:[&>h1:first-child]:leading-[1.35]",
