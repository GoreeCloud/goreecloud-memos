    ...
    <div className={`w-full flex flex-col justify-start items-start text-foreground ${className || ""}`}>
      <div
        ...
        className={cn(
          ...
          "[&>h1:first-child]:mt-0 [&>h1:first-child]:mb-2 [&>h1:first-child]:border-0 [&>h1:first-child]:pb-0 [&>h1:first-child]:text-lg [&>h1:first-child]:font-medium [&>h1:first-child]:leading-6 max-[599px]:[&>h1:first-child]:text-[1.15rem] max-[599px]:[&>h1:first-child]:leading-[1.4]",
